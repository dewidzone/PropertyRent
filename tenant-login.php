...
include("navbar.php");
include("tenant-engine.php"); // Make sure validate() function is included
...
if (isset($_POST['tenant_login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($password === $stored_password) {
            ...
            header("location:index.php"); // Redirect to the tenant dashboard
            exit();
        } else {
...
body {
  background-image: url('images/housem3.jpg'); /* Path relative to the PHP file */
...
<div class="container">
  ...
  <form method="POST">
    ...
    <div class="form-group">
	     <a href="forgot-password-tenant.php" style="color: #ffffff; text-decoration: none;">Forgot your Password?</a>
    </div>
