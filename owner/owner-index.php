...
<body>
 ...
 <div class="container-fluid">
  ...
  <p><b>Type Of Identification: </b><?php echo $rows['id_type']; ?></p>
      ...
      <div class="container">
        ...
        <div class="col-sm-6">
			<div class="form-group">
			  ...
			  <select class="form-control" name="country" required="required" disabled>
            ...
            <div class="form-group">
               <label for="property_type">Property Type:</label>
                <select class="form-control" name="property_type">
                      ...
                      <option value="Flat Rent">Appartment Rent</option>
